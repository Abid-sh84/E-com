        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center group">
              ...
              <span className="ml-2 text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-yellow-200 to-yellow-300 group-hover:from-yellow-200 group-hover:via-yellow-100 group-hover:to-yellow-200 transition-all duration-300">Starry Comics</span>
            </Link>
          </div>
